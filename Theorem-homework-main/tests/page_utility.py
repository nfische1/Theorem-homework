...
class AccountCreationPage(BasePage):
    ...
    def enter_last_name(self, last_name):
        self.wait_for_element_visibility(*AccountCreationPageLocators.LAST_NAME_FIELD)
    ...
    def enter_password(self, password):
        self.wait_for_element_visibility(*AccountCreationPageLocators.PASSWORD_FIELD)
